...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.createTable('seeker_experiences', {
      id:                 { type: Sequelize.INTEGER.UNSIGNED, autoIncrement: true, primaryKey: true },
      seeker_id:          { type: Sequelize.INTEGER.UNSIGNED, allowNull: false, references: { model: 'seeker_profiles', key: 'id' }, onDelete: 'CASCADE' },
    ...
    await queryInterface.createTable('seeker_educations', {
      ...
      qualification_id: { type: Sequelize.INTEGER.UNSIGNED, references: { model: 'qualifications', key: 'id' } },
