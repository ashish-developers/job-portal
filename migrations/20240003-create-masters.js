...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('industries', {
      industry_id:        { type: Sequelize.INTEGER.UNSIGNED, autoIncrement: true, primaryKey: true },
      industry_name:      { type: Sequelize.STRING(100), allowNull: false },
      industry_code:      { type: Sequelize.STRING(20), unique: true },
      parent_industry_id: { type: Sequelize.INTEGER.UNSIGNED, references: { model: 'industries', key: 'industry_id' } },
    ...
    await queryInterface.createTable('job_roles', {
      ...
      dept_id:          { type: Sequelize.INTEGER.UNSIGNED, references: { model: 'departments', key: 'id' } },
