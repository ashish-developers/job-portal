...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable('employers', {
      ...
      industry_id:         { type: Sequelize.INTEGER, references: { model: 'industries', key: 'industry_id' } },
      company_size_id:     { type: Sequelize.INTEGER, references: { model: 'company_sizes', key: 'id' } },
      ...
      verification_status: { type: Sequelize.STRING(50), defaultValue: 'PENDING' },
      verification_note:   { type: Sequelize.TEXT },
      verified_by:         { type: Sequelize.INTEGER },
    ...
    await queryInterface.createTable('role_permissions', {
      id:            { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
      role_id:       { type: Sequelize.INTEGER, allowNull: false, references: { model: 'employer_roles', key: 'id' }, onDelete: 'CASCADE' },
    ...
    await queryInterface.createTable('employer_users', {
      id:                   { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
      employer_id:          { type: Sequelize.INTEGER, allowNull: false, references: { model: 'employers', key: 'id' }, onDelete: 'CASCADE' },
      role_id:              { type: Sequelize.INTEGER, references: { model: 'employer_roles', key: 'id' } },
      name:                 { type: Sequelize.STRING(100), allowNull: false },
